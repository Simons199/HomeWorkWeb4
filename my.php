...
$works = [
    [
        "name" => "Пилот",
        "dateStart" => "Март 2012",
        "dateEnd" => "Теккущее время",
        "description" => "Летаю на ковре самолете",

    ],
    [
        "name" => "Терапевт",
        "dateStart" => "Фефраль 2010",
        "dateEnd" => "Февраль 2012",
        "description" => "Лечил людей",

    ],
    [
        "name" => "Инженер таркторного завода",
        "dateStart" => "Январь 2001",
        "dateEnd" => "Январь 2010",
        "description" => "Создавал трактора",
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
              <?php echo $works[$i]['dateStart'] ?> - <span class="w3-tag w3-teal w3-round">
